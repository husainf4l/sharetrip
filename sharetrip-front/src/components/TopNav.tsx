...
export const TopNav: React.FC<TopNavProps> = ({
  ...
  return (
    <header className={cn("relative bg-gradient-to-r from-blue-600 to-purple-700", className)}>
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center">
              <Link href="/" className="flex items-center gap-2">
                ...
                <span className="text-xl font-bold text-white">ShareTrip</span>
              </Link>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="hidden lg:flex items-center gap-6">
                <Link href="/become-host" className="text-white/90 hover:text-white transition-colors text-sm font-medium">
                  Become a Host
                </Link>
                <Link href="/help" className="text-white/90 hover:text-white transition-colors text-sm font-medium">
                  Help
                </Link>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto leading-relaxed">
              Book unforgettable activities, tours, and experiences around the world.
              From cultural adventures to outdoor thrills.
            </p>
          </div>
