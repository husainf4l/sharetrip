...
const hostSidebarItems = [
  ...
  {
    name: "Accommodations",
    href: "/hostdashboard/accommodations",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
