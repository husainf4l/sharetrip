...
export default function AdventurePage() {
  ...
  const filteredExperiences =
    selectedCategory === "All Categories"
      ...
      : adventureExperiences.filter((exp) => exp.category === selectedCategory);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[40vh] flex items-center justify-center">
        <div
          ...
          style={{ backgroundImage: "url('/hero/resort.webp')" }}
        >
          <div className="absolute inset-0 bg-gradient-to-br from-black/60 via-red-900/30 to-orange-900/40"></div>
        </div>
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-6">
          ...
          >
            Push your limits with extreme sports and thrilling adventures
          </motion.p>
        </div>
      </section>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-gray-900">
            {filteredExperiences.length} Adventure Experiences
          </h2>
