...
export default function AdBanner({ category, className = "" }: AdBannerProps) {
    ...
    const allAds: Record<string, AdTour[]> = {
      ...
      walking: [
        ...
        },
        {
          ...
          image:
            "https://images.unsplash.com/photo-1534351590666-13e3e963b3b6?w=400&h=250&fit=crop",
          price: 25,
          rating: 4.7,
          reviews: 1432,
          duration: "2 hours",
      ...
      private: [
        {
          id: "private-villa-bali",
          title: "Private Villa Experience in Bali",
          location: "Ubud, Bali",
          image:
          ...
          badge: "Luxury",
          badgeColor: "bg-purple-500",
          href: "/tours/private-villa-bali",
        },
        {
          id: "private-yacht-mediterranean",
          title: "Private Yacht Charter in Mediterranean",
          ...
          href: "/tours/private-yacht-mediterranean",
        },
      ],
      default: [
        {
  ...
  return (
    <div
      className={`bg-gradient-to-r from-blue-50 via-purple-50 to-pink-50 rounded-2xl p-6 my-8 ${className}`}
    >
        ...
        {ads.map((ad) => (
          ...
          >
            <div className="relative h-40 overflow-hidden">
              ...
              {ad.badge && (
                <div
                  className={`absolute top-3 left-3 ${ad.badgeColor} text-white px-3 py-1 rounded-full text-xs font-semibold shadow-lg`}
                >
                  {ad.badge}
                </div>
              )}
