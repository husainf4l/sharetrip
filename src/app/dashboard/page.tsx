...
export default function TravelerDashboard() {
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case "completed": return <StarIcon className="w-4 h-4" />; 
              ...
              <div key={booking.id} className="card hover-lift">
                <div className="flex flex-col lg:flex-row gap-6 p-6">
                  ...
                  <div className="relative w-full lg:w-48 h-32 lg:h-32 overflow-hidden rounded-lg">
                    ...
                    />
                    <div className={`absolute top-2 left-2 px-2 py-1 rounded-full text-xs font-medium flex items-center gap-1 ${getStatusColor(booking.status)}`}>
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          ...
                          <div>
                            <div className="text-gray-600 mb-1">
                              <span className="font-medium">Host:</span> {booking.hostName}
                            </div>
                            <div className="text-gray-600">
                              <span className="font-medium">Guests:</span> {booking.participants}
                            </div>
                          </div>
                        </div>
                        ...
                        {booking.meetingPoint && (
                          <div className="mt-3 p-3 bg-blue-50 rounded-lg">
                            <div className="text-sm">
                              <span className="font-medium text-blue-900">Meeting Point:</span>
                              <span className="text-blue-700 ml-2">{booking.meetingPoint}</span>
                            </div>
                          </div>
                        )}
                        ...
                        {booking.status === 'completed' && booking.rating && (
                          <div className="mt-3 p-3 bg-green-50 rounded-lg">
                            <div className="flex items-center gap-2 mb-2">
                              <span className="text-sm font-medium text-green-900">Your Review:</span>
                              <div className="flex">
                                {[...Array(5)].map((_, i) => (
                                  <StarIcon
                                    key={i}
