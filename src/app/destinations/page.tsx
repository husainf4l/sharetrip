  ...
  const allDestinations: Destination[] = [
    {
      ...
      description:
        "The City of Light captivates with iconic landmarks, world-class museums, and romantic charm.",
      highlights: [
        "Eiffel Tower",
        "Louvre Museum",
    ...
    },
    {
      ...
      description:
        "The Eternal City where ancient history meets vibrant modern culture.",
      highlights: [
        "Colosseum",
        "Vatican City",
        "Trevi Fountain",
    ...
    },
    {
      ...
      description:
        "A vibrant Mediterranean city famous for Gaudí architecture and tapas culture.",
      highlights: [
        "Sagrada Familia",
        "Park Güell",
        "Las Ramblas",
    ...
    },
    {
      ...
      description:
        "A historic capital blending royal heritage with cutting-edge culture.",
      highlights: [
        "Big Ben",
        "Tower of London",
        "British Museum",
    ...
    },
    {
      ...
      image: "🇳🇱",
      unsplashImage:
        "https://images.unsplash.com/photo-1534351590666-13e3e963b3b6?w=600&h=400&fit=crop",
      description:
        "A charming city of canals, cycling culture, and artistic heritage.",
      highlights: [
        "Canal Cruise",
        "Van Gogh Museum",
        "Anne Frank House",
    ...
    },
    {
      ...
      description:
        "A fascinating blend of ultra-modern technology and ancient traditions.",
      highlights: [
        "Tokyo Skytree",
        "Senso-ji Temple",
        "Shibuya Crossing",
    ...
    },
    {
      ...
      description:
        "A futuristic city in the desert with luxury shopping and stunning architecture.",
      highlights: [
        "Burj Khalifa",
        "Dubai Mall",
        "Palm Jumeirah",
    ...
    // Additional popular destinations
    {
      ...
      description:
        "A transcontinental city bridging Europe and Asia with rich Byzantine and Ottoman heritage.",
      highlights: [
        "Hagia Sophia",
        "Blue Mosque",
        "Grand Bazaar",
    ...
    },
    {
      ...
      description:
        "A charming coastal capital known for its colorful architecture and delicious cuisine.",
      highlights: [
        "Jerónimos Monastery",
        "Tram 28",
        "Belém Tower",
    ...
    },
    {
      ...
      description:
        "A fairy-tale city with stunning Gothic and Baroque architecture.",
      highlights: [
        "Prague Castle",
        "Charles Bridge",
        "Old Town Square",
    ...
    },
    {
      ...
      description:
        "A stunning island paradise famous for its blue-domed churches and sunset views.",
